...
<body class="bg-warm-ivory text-primary-black font-sans antialiased">
    ...
    <a href="https://wa.me/917679239780"
       target="_blank"
       rel="noopener noreferrer"
       aria-label="Chat with Payal on WhatsApp"
       ...
       class="fixed bottom-6 right-6 z-50 flex items-center justify-center
              ...
              hover:bg-[#20c05a] hover:scale-110 hover:shadow-[0_6px_28px_rgba(37,211,102,0.55)]
        ...
        <span x-show="tooltip"
              ...
              class="absolute right-16 whitespace-nowrap
                     font-sans text-[12px] font-medium text-white
                     bg-primary-black/90 rounded px-3 py-1.5
                     pointer-events-none">
            Chat on WhatsApp
        </span>
